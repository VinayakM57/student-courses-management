...
class Student {
    ...
    private Map<String, Integer> courses; // Fixed the map declaration
    ...
    public Student(String name, String program, int semester) {
        ...
        this.courses = new HashMap<>(); // Corrected the HashMap initialization
    }
    ...
    public void displayLowMarks() {
        ...
        for (Map.Entry<String, Integer> entry : courses.entrySet()) {  // Fixed loop syntax
